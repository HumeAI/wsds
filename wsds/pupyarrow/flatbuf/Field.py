...
class Field(object):
    ...
    def Dictionary(self):
        ...
        if o != 0:
            ...
            from wsds.pupyarrow.flatbuf.DictionaryEncoding import DictionaryEncoding
    ...
    def Children(self, j):
        ...
        if o != 0:
            ...
            from wsds.pupyarrow.flatbuf.Field import Field
            obj = Field()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def CustomMetadata(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from wsds.pupyarrow.flatbuf.KeyValue import KeyValue
            obj = KeyValue()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
