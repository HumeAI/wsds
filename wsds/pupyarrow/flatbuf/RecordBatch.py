...
class RecordBatch(object):
    ...
    def Nodes(self, j):
        ...
        if o != 0:
            ...
            from wsds.pupyarrow.flatbuf.FieldNode import FieldNode
            obj = FieldNode()
    ...
    def Buffers(self, j):
        ...
        if o != 0:
            x = self._tab.Vector(o)
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 16
            from wsds.pupyarrow.flatbuf.Buffer import Buffer
            obj = Buffer()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Compression(self):
        ...
        if o != 0:
            ...
            from wsds.pupyarrow.flatbuf.BodyCompression import BodyCompression
            obj = BodyCompression()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def RecordBatchStart(builder): builder.StartObject(5)
...
def RecordBatchAddVariadicBufferCounts(builder, variadicBufferCounts): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(variadicBufferCounts), 0)
def RecordBatchStartVariadicBufferCountsVector(builder, numElems): return builder.StartVector(8, numElems, 8)
